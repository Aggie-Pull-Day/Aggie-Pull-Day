...
more_groups = [
  { groupname: "Kareem's Group", member: 'Kareem Hirani',
    pulled: false },
  { groupname: "Baldwin's Group", member: 'Baldwin Bakkal',
    pulled: false },
  { groupname: "Reid's Group", member: 'Reid Neason',
    pulled: false },
  { groupname: "Jon's Group", member: 'Jon Waterman',
    pulled: false }
]
