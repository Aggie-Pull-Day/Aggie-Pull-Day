...
Scenario: see details of a game

  Given I am on the games page
  When I press "View Details" within "div.row"
...
Scenario: access edit game page
  ...
  When I press "Edit this Game"
  Then I should be on the edit game page

Scenario: change reflected on info page

  Given I am on the edit game page
  When I enter the opponent "LSU"
  And I press "Update Game"
  Then I should see "Opponent: LSU"

Scenario: change reflected on games page

  Given I am on the edit game page
  When I enter the opponent "Alabama"
  And I press "Update Game"
  And I press "Back to Games"
  Then I should see "TAMU vs. Alabama – Sep 10, 2022"
